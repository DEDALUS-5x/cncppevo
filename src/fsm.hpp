...
public:
  ...
  void install_functions() {
    ...
    // State functions
    add_state(cncpp::STATE_INIT, [](DATA_T &data) -> cncpp::state_t {
      cncpp::state_t next_state = do_init(data);
    
      switch (next_state) {
      case cncpp::UNIMPLEMENTED:
        throw std::runtime_error("State function not fully implemented: "s + "INIT");
        break;
      case cncpp::STATE_IDLE:
      case cncpp::STATE_STOP:
        break;
      default:
        next_state = cncpp::NO_CHANGE;
      }
      return next_state;
    });

    add_state(cncpp::STATE_IDLE, [](DATA_T &data) -> cncpp::state_t {
      cncpp::state_t next_state = do_idle(data);
    
      switch (next_state) {
      case cncpp::UNIMPLEMENTED:
        throw std::runtime_error("State function not fully implemented: "s + "IDLE");
        break;
      case cncpp::NO_CHANGE:
      case cncpp::STATE_IDLE:
      case cncpp::STATE_LOAD_BLOCK:
      case cncpp::STATE_STOP:
      case cncpp::STATE_GO_TO_ZERO:
        break;
      default:
        next_state = cncpp::NO_CHANGE;
      }
    ...
    add_state(cncpp::STATE_STOP, [](DATA_T &data) -> cncpp::state_t {
      cncpp::state_t next_state = do_stop(data);
    ...
    add_state(cncpp::STATE_LOAD_BLOCK, [](DATA_T &data) -> cncpp::state_t {
      cncpp::state_t next_state = do_load_block(data);
      ...
      case cncpp::UNIMPLEMENTED:
        ...
        break;
      case cncpp::STATE_IDLE:
      case cncpp::STATE_NO_MOTION:
      case cncpp::STATE_RAPID_MOTION:
      case cncpp::STATE_INTERP_MOTION:
        break;
      default:
        next_state = cncpp::NO_CHANGE;
      }
    ...
    add_state(cncpp::STATE_GO_TO_ZERO, [](DATA_T &data) -> cncpp::state_t {
      cncpp::state_t next_state = do_go_to_zero(data);
    ...
    add_state(cncpp::STATE_NO_MOTION, [](DATA_T &data) -> cncpp::state_t {
      cncpp::state_t next_state = do_no_motion(data);
    ...
    add_state(cncpp::STATE_RAPID_MOTION, [](DATA_T &data) -> cncpp::state_t {
      cncpp::state_t next_state = do_rapid_motion(data);
    ...
    add_state(cncpp::STATE_INTERP_MOTION, [](DATA_T &data) -> cncpp::state_t {
      cncpp::state_t next_state = do_interp_motion(data);
